...
<p>Latest stable version is <b>1.6.2</b>. The RPMs may be a little out of date,
...
<?php Download("SHA256-1.6.2.txt.asc", "are also available"); ?>.
</p>

<h3>Microsoft Windows</h3>
<p>Windows installer (Windows 7 or later), version 1.6.2: &nbsp;
<?php Download("dopewars-1.6.2-32bit.exe", "32-bit"); ?>; &nbsp;
<?php Download("dopewars-1.6.2-64bit.exe", "64-bit"); ?>
<br />
...
<?php Download("SHA256-1.6.2.txt.asc", "checksum and GPG signature"); ?>).
</p>

<h3>RedHat Enterprise Linux 7 (and similar)</h3>
<p>Binary RPM for 64-bit RedHat Enterprise 7, version 1.6.2: &nbsp;
<?php Download("dopewars-1.6.2-1.el7.x86_64.rpm"); ?>
<br />
SDL_mixer (Simple DirectMedia Layer) sound plugin: &nbsp;
<?php Download("dopewars-sdl-1.6.2-1.el7.x86_64.rpm"); ?>
</p>

<h3>Fedora Linux 36 (and similar)</h3>
<p>Binary RPM for 64-bit Fedora 36, version 1.6.2: &nbsp;
<?php Download("dopewars-1.6.2-1.fc36.x86_64.rpm"); ?>
<br />
SDL_mixer (Simple DirectMedia Layer) sound plugin: &nbsp;
<?php Download("dopewars-sdl-1.6.2-1.fc36.x86_64.rpm"); ?>
</p>

<h3>Source code</h3>
<p>Source RPM, version 1.6.2: &nbsp;
<?php Download("dopewars-1.6.2-1.el7.src.rpm"); ?>
</p>

<p>Source code tarball, version 1.6.2: &nbsp;
<?php Download("dopewars-1.6.2.tar.gz"); ?>
</p>
...
<p>Text documentation: &nbsp;
   <a href="https://github.com/benmwebb/dopewars/blob/main/README.md">README.md</a>
</p>

<p>List of changes in this and earlier versions (ChangeLog): &nbsp;
   <a href="https://github.com/benmwebb/dopewars/blob/main/ChangeLog.md">ChangeLog.md</a>
</p>

<p>Example configuration file for dopewars: &nbsp;
   <a href="https://github.com/benmwebb/dopewars/blob/main/doc/example-cfg">example-cfg</a>
</p>
